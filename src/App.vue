     ...
     class="max-w-xl mx-auto p-5 text-left">
        <div class="grid gap-6 mb-6 md:grid-cols-2">
            ...
            <div>
                ...
                <input v-model="form.media" type="text" id="media" name="media" class="outline-none  bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-dodger-blue-500 focus:border-dodger-blue-500 block w-full p-2.5 dark:bg-dodger-blue-900 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-dodger-blue-500 dark:focus:border-dodger-blue-500" placeholder="" required>
            </div>  
            <div>
                <label for="phone" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Country</label>
                <input v-model="form.country" type="text" id="country" name="country" class="outline-none  bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-dodger-blue-500 focus:border-dodger-blue-500 block w-full p-2.5 dark:bg-dodger-blue-900 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-dodger-blue-500 dark:focus:border-dodger-blue-500" placeholder="" required>
            </div>
        </div>
        <div class="mb-6">
            <label for="email" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Email address</label>
            <input v-model="form.email" type="email" id="email" name="email" class="outline-none  bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-dodger-blue-500 focus:border-dodger-blue-500 block w-full p-2.5 dark:bg-dodger-blue-900 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-dodger-blue-500 dark:focus:border-dodger-blue-500" placeholder="" required>
        </div>
